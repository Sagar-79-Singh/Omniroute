...
import { register_proxy_subscriptions } from "./proxy-subscriptions.mjs";
...
export function registerApiCommands(program) {
  ...
  register_proxy_subscriptions(api);
  register_usage(api);
